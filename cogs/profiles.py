...
class Profiles(commands.Cog):
    ...
    async def profile(self, interaction: discord.Interaction, user: discord.User = None):
        ...
        embed.set_footer(text="A Mythical Tale", icon_url="https://media.discordapp.net/attachments/927723310559686707/1395181866289594520/AMTLogoCutOut.png?ex=687b7e1e&is=687a2c9e&hm=fa7627f8494175b9da68108870c5e9504f9d08475c4a4d10e8696e2b85585eb6&=&format=webp&quality=lossless&width=992&height=992")
